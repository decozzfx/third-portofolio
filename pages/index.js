        ...
        <List display={{base :'', sm: 'flex'}}>
          <ListItem>
            <Link href='https://github.com/decozzfx' target='_blank'>
              <Button variant='ghost' colorScheme='teal' leftIcon={<Icon as={IoLogoGithub} />}>@decozzfx</Button>
            </Link>
          </ListItem>
          <ListItem>
            <Link href='https://twitter.com/decozzfx' target='_blank'>
              <Button variant='ghost' colorScheme='teal' leftIcon={<Icon as={IoLogoTwitter} />}>@decozzfx</Button>
            </Link>
          </ListItem>
          <ListItem>
            <Link href='https://mail.google.com/mail/u/0/?fs=1&to=decozzfx@gmail.com&tf=cm' target='_blank'>
              <Button variant='ghost' colorScheme='teal' leftIcon={<Icon as={IoMailOutline} />}>decozzfx</Button>
            </Link>
          </ListItem>
        </List>
      </Section>
